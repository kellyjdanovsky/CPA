...
//PRINT RECU DECAISSEMENT
// Route::get('/decrecu/{id}', function ($id) {

//     $decaissement = \App\Models\decaissement::find($id);

//     return view('pages.support_team.payments.decrecu', ['dec' => $decaissement]);
// })->name('decaissement.print');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['namespace' => 'SupportTeam',], function(){
        ...
        Route::group(['prefix' => 'payments'], function(){
            ...
            Route::get('manage/{class_id?}', 'PaymentController@verified')->name('payments.verified');
            ...
            Route::get('caisse', 'PaymentController@caisse')->name('payments.caisse');
            Route::post('decaisse', 'PaymentController@decaissement')->name('payments.decaissement');
            Route::get('decrecu/{id}', 'PaymentController@decaissementPrint')->name('decaissement.print');
