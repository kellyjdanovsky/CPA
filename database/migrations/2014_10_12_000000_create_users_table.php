...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('nom_m', 100)->nullable()->unique();
            $table->string('nom_p', 100)->nullable()->unique();
            $table->string('prof_p', 100)->nullable()->unique();
            $table->string('prof_m', 100)->nullable()->unique();
