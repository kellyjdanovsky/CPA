...
@section('content')
        <div class="card">
            <div class="card-header bg-white header-elements-inline">
                <h6 class="card-title">Veuillez remplir le formulaire pour inscricre une nouvelle edtudiant</h6>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input name="dob" value="{{ old('dob') }}" type="text" class="form-control date-pick" placeholder="Choix Date...">
