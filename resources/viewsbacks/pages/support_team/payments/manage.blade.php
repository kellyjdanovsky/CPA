...
@section('page_title', 'Paiement des Etdiants')
@section('content')
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"><i class="icon-cash2 mr-2"></i> Paiement des Etdiants</h5>
            {!! Qs::getPanelOptions() !!}
        </div>
                    ...
                    @foreach($students as $s)
                        <tr>
                            ...
                            <div class="dropdown-menu dropdown-menu-left">
                                <a href="{{ route('payments.invoice', [Qs::hash($s->user_id)]) }}" class="dropdown-item">Toutes les Paiements</a>
