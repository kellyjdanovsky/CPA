        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6 border-right-2 border-right-blue-400">
                        ...
                        <div class="form-group row">
                            <label for="current_session" class="col-lg-3 col-form-label font-weight-semibold">Année scolaire actuelle <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                                <div class="alert alert-warning border-0 alert-dismissible">
                                    <span class="font-weight-semibold">Attention!</span>
                                    Changer l'année scolaire affectera l'affichage des données dans tout le système.
                                    Les données des années précédentes resteront accessibles en revenant à ces années.
                                </div>
                        ...
                        <div class="form-group row">
                            <label for="lock_exam" class="col-lg-3 col-form-label font-weight-semibold">Bloquer les examens</label>
                            <div class="col-lg-3">
