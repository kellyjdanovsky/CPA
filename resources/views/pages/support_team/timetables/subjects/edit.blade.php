<div class="tab-pane fade" id="edit-subs">
    ...
    @if($tts->count())
                                ...
                                <div class="col-md-12">
                                    <form  method="post" action="{{ route('tt.update', $tt->id) }}">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label for="ts_id" class="col-lg-3 col-form-label font-weight-semibold">Plage horaire <span
        ...
        @endforeach
    @else
        <div class="alert alert-info text-center">Aucun enregistrement à afficher. Ajoutez des matières à l'enregistrement de l'emploi du temps et rafraîchissez la page.
        </div>
    @endif
</div>
