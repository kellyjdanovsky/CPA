<div class="row">
    <div class="col-md-12">
        <div class="alert alert-info text-center">
            <span>Vous pouvez ajouter de nouveaux créneaux horaires ou choisir d'utiliser des créneaux horaires existants d'un autre emploi du temps. <strong>NB :</strong> Utiliser des créneaux horaires existants réinitialise l'emploi du temps actuel</span>
        </div>
    </div>
