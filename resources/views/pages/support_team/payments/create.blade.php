...
@section('page_title', 'Création de paiement')
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Création de Paiement</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="col-md-6">
                    <form class="ajax-store" method="post" action="{{ route('payments.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input name="title" value="{{ old('title') }}" required type="text" class="form-control" placeholder="Ex. ecolage">
                            </div>
                        </div>

                        <div class="form-group row">
                            <label for="my_class_id" class="col-lg-3 col-form-label font-weight-semibold">Classes </label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            <label for="amount" class="col-lg-3 col-form-label font-weight-semibold">Montant (Ar) <span class="text-danger">*</span></label>
                            <div class="col-lg-9">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary" data-text="Création en cours...">Valider <i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
            </div>
