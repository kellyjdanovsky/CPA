...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-white header-elements-inline">
            <h6 id="ajax-title" class="card-title">Veuillez remplir le formulaire ci-dessous pour modifier les informations de {{ $sr->user->name }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input name="dob" value="{{ $sr->user->dob }}" type="text" class="form-control date-pick" placeholder="Choisir une date...">
