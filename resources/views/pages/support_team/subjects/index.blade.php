                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('subjects.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="name" class="col-lg-3 col-form-label font-weight-semibold">Coefficient <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                        <input id="name" name="coef" value="{{ old('name') }}" required type="number" class="form-control" placeholder="coefficien 1 minimum">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <input id="slug" required name="slug" value="{{ old('slug') }}" type="text" class="form-control" placeholder="Par ex. B.Eng">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="my_class_id" class="col-lg-3 col-form-label font-weight-semibold">Sélectionner une classe <span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        <select required data-placeholder="Sélectionner un enseignant" class="form-control select-search" name="teacher_id" id="teacher_id">
                                            <option value=""></option>
