                    ...
                    <div class="card mb-0">
                        <div class="card-body" >
                            ...
                            <div class="form-group ">
                                <input type="text" class="form-control" name="identity" value="{{ old('identity') }}" placeholder="Votre Email ou Nom d'utilisateur">
                            </div>
                            ...
                            <div class="form-group d-flex align-items-center">
                                ...
                                <a href="{{ route('password.request') }}" class="ml-auto">Mot de passe Oublier?</a>
                            </div>
